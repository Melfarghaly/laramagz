...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
      Setting::insert([
          ...
          ['group' => 'site_config', 'name' => 'analytics_view_id', 'value' => '', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ['group' => 'site_config', 'name' => 'credentials_file', 'value' => '', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          ['group' => 'logo_image', 'name' => 'logodashboard', 'value' => '', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ['group' => 'logo_image', 'name' => 'logoauth', 'value' => '', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          ['group' => 'google', 'name' => 'googleanalyticsid', 'value' => 'UA-166274905-1', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          ['group' => 'google', 'name' => 'googlesiteverification', 'value' => 'DM6yrSbyEPMHikBIGXjUlRDyzjs49GLjXy_wQ3T3SP0', 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s')],
